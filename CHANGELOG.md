...
### Changed
- Removed the `version` subcommand. Use `containerctl --version` instead (prints version, build date, Go version, OS/arch). Engine reachability details are no longer included.
