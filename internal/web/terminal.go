...
var cmdHelp = map[string]string{
	...
	"restart":  "recreate containers from current config  (--follow to stream logs, single container)",
	"start":    "start stopped containers  (--follow to stream logs, single container)",
